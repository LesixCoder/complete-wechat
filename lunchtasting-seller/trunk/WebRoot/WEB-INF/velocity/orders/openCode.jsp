				...
				<div class="panel-body">
					...
					<form role="form" method="post" class="form-horizontal validate" id="restaurant-form" target="ifa">
						<div class="form-group" name="check-div">
							...
							<div class="col-sm-10">
							<input type="text" class="form-control" id="code" name="code"  data-validate="required" data-message-required="商家名称为必填项" placeholder="输入商家名称" aria-required="true" aria-describedby="name-error" aria-invalid="true" maxlength="30">
							</div>
						</div>
						<div class="form-group-separator"></div>
						<div class="form-group">
							<button type="button" class="btn btn-success" id="seller-save" 	>保存</button>
			...
			var data = {
				...
				jQuery.ajax({
				    ...
				    success:function(data){
				    	alert(data.message);
				    	alert(JSON.stringify(data.data.ordersList.length));
				    },
				     error : function() {
				        alert("服务器连接失败！");
				     }    
