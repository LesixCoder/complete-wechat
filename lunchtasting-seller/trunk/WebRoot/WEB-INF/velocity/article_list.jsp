...
<!-- 					</div> -->
		...
		<div class="main-content">
			...
			<!-- <div align="left" style="padding-right:330px;">
			<form method="post" class="form-horizontal" id="agents-form">
			<div class="form-group" align="center">
			<label class="col-sm-2 control-label" for="restaurant.restaurantName">商家名称</label>
							<div class="col-sm-2">
								<input type="text" class="form-control" id="agentName" style="width: 140px;" maxlength="10">
							</div>
							<div class="col-sm-2">
...
<!-- 					    <a href="javascript:selectAgents();" class="btn btn-secondary btn-sm btn-icon icon-left" style="color:#ffffff;">查询</a> -->
...
// 					                jQuery('td:eq(2)', nRow).html( aoData.address.substr(0, 8)+"...");
// 					            }
// 					        },
// 							"fnServerParams" : function (aoData) {
// 								aoData.push(
// 								{ "name": "agentName", "value": jQuery("#agentName").val() },
// 								{ "name": "state", "value": jQuery("#stateSelect").val() }
// 								    );
// 							},
							aoColumns: [
							...
							columnDefs: [{
								...
								"render": function(data, type, row,full) { //返回自定义内容
									...
									html += "<a href='javascript:deleteArticle("+data+");' class='btn btn-danger btn-sm btn-icon icon-left'>删除</a>";
									if(row.flag == 0){
									html += "<a href='javascript:cancel("+data+");' class='btn btn-info btn-sm btn-icon icon-left'>撤销</a>";
									}else{
									html += "<a href='javascript:publish("+data+");' class='btn btn-info btn-sm btn-icon icon-left'>发布</a>";
									}
