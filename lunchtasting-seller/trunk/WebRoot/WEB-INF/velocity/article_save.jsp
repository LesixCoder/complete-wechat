				...
				<div class="panel-body">
					...
					<form role="form" method="post" class="form-horizontal validate" id="restaurant-form" target="ifa">
						...
						<div class="form-group" name="check-div">
							...
							<div class="col-sm-10">
							<input type="text" class="form-control" id="name" name="name" value="$!{article.name}" data-validate="required" data-message-required="文章名称为必填项" placeholder="输入文章名称" aria-required="true" aria-describedby="name-error" aria-invalid="true" maxlength="30">
							</div>
						</div>
						...
						<div class="form-group" name="check-div">
							...
							<div class="col-sm-10">
							<input type="text" class="form-control" id="content" name="content" value="$!{article.content}" data-validate="required" data-message-required="文章简介为必填项" placeholder="输入文章简介" aria-required="true" aria-describedby="content-error" aria-invalid="true" maxlength="30">
							</div>
						</div>
						<div class="form-group-separator"></div>
						<div class="form-group" name="check-div">
