...
<body>
	<section class="wrapBox">
		<section class="course_coupon_list wrapBox-phone">
			<p class="coupon_exchanged"><span><img src="$!staticPrefix/wechat/images/course/coupon/gift-icon.png" alt=""> <a href="/gift_coupon/exchange/list">已兑换</a></span></p>
			<section class="coupon_list_content">
				#foreach($bean in $list)
				#if("$!bean.id" != "1")
				<article class="coupon_article #if("$!bean.status" == "2")coupon_article-end #end">
				...
				#else
				<article class="coupon_article coupon_article_new #if("$!bean.status" == "2")coupon_article-end #end">
					<a href="/gift_coupon/detail?id=$!bean.id">
						<div class="article_left">
