		...
		<section class="order_confirm">
			<section class="confirm_box">
				...
				<section class="dialog_d_list">
					<p><i class="color-yellow">课程名称：<em></em></i><span>$!courseMeal.course_name</span></p>
					<p><i class="color-yellow">套餐名称：<em></em></i><span>$!courseMeal.name</span></p>
					<p><i class="color-yellow">课程数：<em></em></i><span>$!courseMeal.course_number</span></p>
					...
					<p><i class="color-yellow">授课教练：<em></em></i><span>$!courseMeal.coach_name</span></p>
