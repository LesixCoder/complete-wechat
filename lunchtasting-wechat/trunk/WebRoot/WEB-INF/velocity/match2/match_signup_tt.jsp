...
<head>
	...
	<link rel="stylesheet" href="$!staticPrefix/wechat/css/plugs/nice-select.css" />
	...
	<div class="wrapBox wrapBox_iphone">
		<section class="subInfor_index">
			<div class="infor_input">
				...
				<p><i class="fa fa-newspaper-o"></i><input id="infor_id" type="text" placeholder="输入您的身份证号" pattern="^(\d{6})(\d{4})(\d{2})(\d{2})(\d{3})([0-9]|X)$" required><em class="id_Box fa"></em></p>
				<p class="p_gender">
					<i class="fa fa-male"></i>
					<select id="infor_gender" class="wide">
						<option value="男" data-display="男">男</option>
			...
			<div class="infor_goods">
				...
				<figure class="goods_box">
					...
					<figcaption>
						<div><h5>$!ticket.name</h5><em>*$!ticketNumber</em></div>
		...
		<input id="ticketNumber" type="hidden" value="$!ticketNumber">
		
	</div>
	<script type="text/javascript" src="http://apps.bdimg.com/libs/jquery/2.1.4/jquery.min.js"></script>
	<script src="$!staticPrefix/wechat/js/plugs/jquery.nice-select.min.js"></script>
	<script type="text/javascript" src="$!staticPrefix/wechat/js/enlist/enlist_index.js"></script>
	<script>
		//下拉初始化
		jQuery(document).ready(function() {
			jQuery('#infor_gender').niceSelect();
		});
	</script>
</body>
