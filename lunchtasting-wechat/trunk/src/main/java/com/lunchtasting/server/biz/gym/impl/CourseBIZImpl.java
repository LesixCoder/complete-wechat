...
public class CourseBIZImpl implements CourseBIZ {
	...
	public Map getCourseDtail(Long courseId) {
		...
		if(map != null){
			 ...
			 */
			List tagList = null;
			if(ValidatorHelper.isMapNotEmpty(map.get("tag"))){
				tagList = new ArrayList();
				String imgArray = map.get("tag").toString();
	...
	public List queryCourseMealList(Long courseId) {
		return courseDAO.queryCourseMealList(courseId);
	}

	@Override
	public Map getCourseMealDetail(Long courseMealId) {
		Map map = courseDAO.getCourseMealDetail(courseMealId);
		if(map != null){
...
//		return courseDAO.getCourseCount(areaId, categoryId);
//	}
//
//	@Override
//	public List queryCourseList(Long areaId, Long categoryId,Integer page, Integer pageSize) {
//		List list = courseDAO.queryCourseList(areaId, categoryId, page, pageSize);
