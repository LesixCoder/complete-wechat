...
public interface UserBIZ {
	 ...
	 * @throws Exception
	 */
	Map loginSeller(Long userId,HttpServletRequest request) throws Exception;
	 ...
	 * @return
	 */
	Boolean updateInfo(Long userId,String name,String imgUrl,String sex,String hobby,String feeling);
