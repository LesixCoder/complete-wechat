...
//		int b = 300;
//		float c = (float)a/b;
//		float d = Float.parseFloat(df.format(c));
//		int e = (int) (500*d);
//		
...
//		float scale = getRatio(daWidth, daHeight, width, height);
//		int imageWidth = (int) (scale * daWidth);
//		int imageHeight = (int) (scale * daHeight);
//		System.out.println(scale + "//"+imageWidth + "//" +imageHeight);
//
//		
//		if(imageWidth > 1080 || imageHeight > 936){
//			float scale2 = getRatio(imageWidth, imageHeight, width, height);
//			int imageWidth2 = (int) (scale2 * imageWidth);
//			int imageHeight2 = (int) (scale2 * imageHeight);
//			System.out.println(scale2 + "//"+imageWidth2 + "//" +imageHeight2);
//		}
		
		System.out.println(CommonHelper.getImageSize(0, 0, 1080, 936));
...
//	public static void getJs(int imgW,int imgH){
//		int targetW = 1080;
//		int targetH = 936;
//		
//		double sx = (double) targetW / imgW;
//		double sy = (double) targetH / imgH;
//		
