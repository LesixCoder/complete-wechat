...
public class UserDeviceBIZImpl implements UserDeviceBIZ {
	...
	@Override
	public Boolean verifyByIdfa(String idfa, String appid) {
		// TODO Auto-generated method stub
		Integer pf = userDeviceDAO.getDeviceCount(appid, idfa);
		if(pf!=null && pf>0){
			return true;
		}
		return false;
	...
	public void updateDeviceToken(Long userId, String deviceToken) {
		userDeviceDAO.updateDeviceToken(userId, deviceToken);
	}
