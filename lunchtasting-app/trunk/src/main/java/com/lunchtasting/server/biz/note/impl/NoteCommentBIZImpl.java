...
public class NoteCommentBIZImpl implements NoteCommentBIZ{
	...
	public Boolean publish(Long userId,Long noteId,Long noteUserId,String content) {
		...
		if(userHotDAO.getTypeCount(userId,SysEnum.UserHotType.ADD_NOTE_COMMENT.getType())<20){
			userHotDAO.createUserHot(userId, SysEnum.UserHotType.ADD_NOTE_COMMENT.getNumber(), SysEnum.UserHotType.ADD_NOTE_COMMENT.getType());
		}
		return true;
	}
