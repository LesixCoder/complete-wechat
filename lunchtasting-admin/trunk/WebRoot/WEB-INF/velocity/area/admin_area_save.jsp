...
<!-- 					</div> -->
				...
				<div class="panel-body">
					...
					<form role="form" method="post" class="form-horizontal validate" id="restaurant-form" target="ifa">
						...
						<div class="form-group" name="check-div">
							<label class="col-sm-2 control-label" for="restaurant.areaName">名称</label>
							<div class="col-sm-10">
							<input type="text" class="form-control" id="name" name="name" value="$!{area.name}" data-validate="required" data-message-required="区域名称为必填项" placeholder="输入区域名称" aria-required="true" aria-describedby="name-error" aria-invalid="true" maxlength="10">
							</div>
						</div>
	...
	<script type="text/javascript">
		...
		jQuery("#activity-save").click(function(){
			show_loading_bar(50);
