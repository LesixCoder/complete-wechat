			...
			<div class="panel panel-default">
					...
					<form class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-2 control-label"
								for="restaurant.restaurantName">商家名称</label>
							<div class="col-sm-2">
								<input type="text" class="form-control" id="name"
									style="width: 140px;">
							</div>
							<label class="col-sm-2 control-label"
								for="restaurant.restaurantName">商家电话</label>
							<div class="col-sm-2">
						...
						<div id="hideDiv">
							<div class="form-group">
								<label class="col-sm-2 control-label"
									for="restaurant.restaurantName">商家地址</label>
								<div class="col-sm-2">
									<input type="text" class="form-control" id="specificAddress"
										style="width: 140px;">
								</div>
								<label class="col-sm-2 control-label"
									for="restaurant.restaurantName">商家状态</label>
				...
				<div class="panel-heading" style="padding-left: 17px;">
					<h3 class="panel-title">
					    <a href="javascript:selectSeller();" class="btn btn-secondary btn-sm btn-icon icon-left" style="color:#ffffff;">查询</a>
						<a href="goSellerSave" class="btn btn-info btn-sm btn-icon icon-left" style="color:#ffffff;">添加</a>
<!-- 						<a href="javascript:void(0);" class="btn btn-orange btn-sm btn-icon icon-left" style="color:#ffffff;" id="uploadButton">导入</a> -->
				...
				<script type="text/javascript">
					...
					jQuery(document).ready(function($){
						    sellerList = jQuery("#example-2").dataTable({
							sAjaxSource: "querySellerList",
							bServerSide: true,
							...
							"fnServerParams" : function (aoData) {
								...
								{ "name": "phone", "value": jQuery("#phone").val() },
							...
							aoColumns: [
								...
								{"mDataProp": "introduction","sClass": "thead-tr-th"},
						...
						KindEditor.ready(function(K) {
							var uploadbutton = K.uploadbutton({
								...
								fieldName : 'imgFile',
								url : 'excel/importSeller?dir=file',
					...
					<table class="table table-bordered table-striped " id="example-2" data-pattern="priority-columns">
						<thead>
							<tr>
								...
								<th style="font-size: 13px;">地址</th>
								<th style="font-size: 13px;">标签</th>
								<th style="font-size: 13px;">电话</th>
							</tr>
						</thead>
