				...
				<div class="panel-body">
					...
					<form role="form" method="post" class="form-horizontal validate" id="restaurant-form" target="ifa">
						...
						<div class="form-group" name="check-div">
							...
							<div class="col-sm-10">
							<input type="text" class="form-control" id="name" name="name" value="$!{user.name}" data-validate="required" data-message-required="昵称为必填项" placeholder="输入昵称" aria-describedby="name-error" aria-invalid="true" maxlength="3000">
							</div>
						</div>
						#if(!$!{user.phone})
						...
						<div class="form-group" name="check-div">
							...
							<div class="col-sm-10">
							<input type="text" class="form-control" id="phone" name="phone" value="$!{user.phone}" placeholder="输入电话" aria-describedby="phone-error" aria-invalid="true" maxlength="3000">
							</div>
						</div>
						#end
						<div class="form-group-separator"></div>
						<div class="form-group" name="check-div">
							<label class="col-sm-2 control-label" for="activity.name">性别</label>
							<div class="col-sm-10" lang="div1">
							<div class="col-sm-12">
    								<select class="form-control selectpicker bla bla bli" data-live-search="false" id="sex" data-validate="required" data-message-required="" aria-required="true" aria-describedby="seller-error" aria-invalid="true" style="display: block; visibility: visible; width: 395px; height: 35px; opacity: 100; position: absolute; top: 0px; left: 0px; cursor: pointer; z-index: 999999; margin: 0px; padding: 6px; -webkit-appearance: menulist-button;">
    								    <option value="1" "#if("1" == $!{user.sex}) selected="selected" #end">男</option>
										<option value="2" "#if("2" == $!{user.sex}) selected="selected" #end">女</option>
									</select>  
							</div>
							</div>
						</div>
