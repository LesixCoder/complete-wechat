		...
		<div class="main-content">
			...
			<div class="panel panel-default">
				...
				<h3 class="panel-title">
						<a href="goActivityList" class="btn btn-info btn-sm btn-icon icon-left" style="color:#ffffff;">返回</a>
				</h3>
				...
				<script type="text/javascript">
					...
					jQuery(document).ready(function($){
						    enrollList = jQuery("#example-2").dataTable({
							sAjaxSource: "queryEnroll?activityId="+"$!activityId",
							bServerSide: true,
					...
					<strong><font color="red">报名总人数：<span id="total"></span></font></strong>
					<table class="table table-bordered table-striped " id="example-2" data-pattern="priority-columns">
						<thead>
							<tr>
								<th style="font-size: 13px;">姓名</th>
								<th style="font-size: 13px;">手机号码</th>
