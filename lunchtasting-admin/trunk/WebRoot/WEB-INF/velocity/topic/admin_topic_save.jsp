...
<!-- 						<div class="form-group" name="check-div" id="hideOrShow">
						...
						<div class="form-group" name="check-div" id="hideOrShow">
							...
							<div class="col-sm-12">
    								<select class="form-control selectpicker bla bla bli" data-live-search="false" id="type" data-validate="required" aria-required="true" aria-describedby="kc-error" aria-invalid="true" style="display: block; visibility: visible; width: 795px; height: 35px; opacity: 100; position: absolute; top: 0px; left: 0px; cursor: pointer; z-index: 999999; margin: 0px; padding: 6px; -webkit-appearance: menulist-button;">
										<option value="1" "#if("1" == $!{bean.type}) selected="selected" #end">话题</option>
									</select>  
							</div>
							</div>
						</div>
						...
						<div class="form-group" name="check-div">
							...
							<div class="col-sm-10">
							<input type="text" class="form-control" id="name" name="name" value="$!{bean.name}" data-validate="required" data-message-required="名称为必填项" placeholder="输入名称" aria-describedby="name-error" aria-invalid="true" maxlength="30">
							</div>
						</div>
						<div class="form-group-separator"></div>
						<div class="form-group" name="check-div">
							...
							<div class="col-sm-10">
							<input type="text" class="form-control" id="sort" name="sort" value="$!{bean.sort}" placeholder="默认99，如不排序，无需填写" aria-describedby="sort-error" aria-invalid="true" maxlength="10" onkeyup='this.value=this.value.replace(/\D/gi,"")'>
							</div>
						</div>
