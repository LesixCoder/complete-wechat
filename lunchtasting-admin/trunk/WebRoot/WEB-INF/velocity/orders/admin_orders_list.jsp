				...
				<div class="title-env">
					...
					<div class="breadcrumb-env">
						...
						<li>
										...
										<a href="goSettlementList">结算管理</a>
								</li>
							<li class="active">
...
<!-- 					    <a href="javascript:selectOrders();" class="btn btn-secondary btn-sm btn-icon icon-left" style="color:#ffffff;">查询</a> -->
						<a href="goSettlementList" class="btn btn-info btn-sm btn-icon icon-left" style="color:#ffffff;">返回</a>
					</h3>
				...
				<script type="text/javascript">
					...
					jQuery(document).ready(function($){
							...
							sAjaxSource: "queryOrdersList?sellerId="+"$!sellerId",
							bServerSide: true,
...
// 								{"mDataProp": "newId", "sClass": "thead-tr-th"},
								...
								{"mDataProp": "payType","sClass": "thead-tr-th"},
