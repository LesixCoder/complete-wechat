    ...
    <div class="wrapper-Box">
        ...
        <section class="content-com">
            <header class="header-details">
                <img src="$!activity.img_url" alt="">
                <h3>$!activity.name</h3>
                <div>
                    <p><span><i>$!activity.now_enroll_num</i>/<i>$!activity.enroll_num </i>报名</span></p>
                    <p><span><i>$!activity.price</i>元/人</span>&nbsp;<span>￥<i>$!activity.market_price</i></span></p>
                    <p><span><i>$!activity.time</i></span></p>
                    <p><span>$!activity.address</span></p>  
                </div>
            </header>
...
<script type="text/javascript">
	...
	var map = new AMap.Map('myMap',{
	    ...
	    center: [$activity.longitude,$activity.latitude], //地图中心点坐标值(经度，纬度)
	...
	var marker = new AMap.Marker({
	    position: [$activity.longitude,$activity.latitude], //后台传入经纬度
	    map:map
	});
	//工具条和比例尺
