...
public class MapResult {
	...
	public static final int CODE_VERSION_EXPIRE  = 10007; // 版本过期，请下载新版本
//	public static final int CODE_IS_BAN = 10008; // 用户被禁用
//	public static final int CODE_IS_BLACKLIST = 10009; // 用户被拉黑名单
	...
	public static Map build(int code,String message){
		Map map = new HashMap();
		map.put(CODE, code);
	...
	public static Map build(int code,String message,Map data){
		Map map = new HashMap();
		map.put(CODE, code);
		map.put(MESSAGE, message);
		if(data != null){
