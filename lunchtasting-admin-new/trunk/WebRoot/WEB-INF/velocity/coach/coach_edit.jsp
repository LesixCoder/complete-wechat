  ...
  <div class="wrap">
    ...
    <table class="list-style">
      <tr>
        ...
        <td>
          <input id="coach_name" type="text" class="textBox" value="$!coach.name" required />
        </td>
      </tr>
      <tr>
        <td style="text-align:center;">
        ...
        <td>
          <select id="coach_gymName" class="textBox" value="$!coach.gym_id" required>
      ...
      <tr>
        ...
        <td>
          <select id="coach_gender" class="textBox" value="$!coach.sex" required>
      ...
      <tr>
        ...
        <td>
          <input id="coach_phone" type="tel" class="textBox" value="$!coach.phone" required pattern="^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$"
          />
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input id="coach_age" type="number" class="textBox length-short" min="0" value="$!coach.age" required pattern="^\d+$" />
          <span>（数字）</span>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input id="coach_birth" type="text" class="textBox" value="$!coach.birth" required pattern="^[1-2][0-9][0-9][0-9]-[0-1]{0,1}[0-9]-[0-3]{0,1}[0-9]$"
          />
      ...
      <tr>
        ...
        <td>
          <input id="coach_year" type="number" class="textBox length-short" min="0" value="$!coach.year" required pattern="^\d+$" />
          <span>（数字）</span>
        </td>
      </tr>
      <tr>
        ...
        <textarea id="coach_cert" style="width: 400px;height: 150px" required>$!coach.certificate</textarea>
      </tr>
      <tr>
        <td style="text-align:center;">
      ...
      <tr>
        ...
        <td class="coach_cover_img">
          <img src="$!coach.img_url" alt="" data-name="$!coach.img_name"/>
        </td>
      </tr>
      <tr>
        <td style="text-align:right;"></td>
