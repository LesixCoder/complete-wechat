...
<body>
 <div class="wrap">
  <div class="page-title">
    <span class="modular fl"><i class="add"></i><em>课程编辑</em></span>
    <span class="modular fr"><a href="/course/list" class="pt-link-btn">课程编辑</a></span>
  </div>
  <table class="list-style">
   <tr>
    <td style="text-align:right;width:8%;">名称：</td>
    <td><input id="name" name="name" type="text" class="textBox"  value="$!course.name"/></td>
   </tr>
   <tr>
    <td style="text-align:right;width:8%;">类型：</td>
    <td><input id="mold" name="mold" type="text" class="textBox length-long"  value="$!course.mold"/></td>
   </tr>
   <tr>
    <td style="text-align:right;width:8%;">特征：</td>
    <td><textarea id="characteristic" name="characteristic" style="width: 400px;height: 100px">$!course.characteristic</textarea></td>
   </tr>
   <tr>
    <td style="text-align:right;width:8%;">标签：</td>
    <td>
    <input id="tag" name="tag" type="text" class="textBox length-long"  value="$!course.tag"/>
	<span>英文逗号分隔 ',' 例：帅气,漂亮</span>
    </td>
   </tr>
   <tr>
    <td style="text-align:right;width:8%;">亮点：</td>
    <td><textarea id="highlight" name="highlight" style="width: 400px;height: 100px">$!course.highlight</textarea></td>
   </tr>
   <tr>
    <td style="text-align:right;width:8%;">流程：</td>
    <td>
    	<textarea id="process" name="process" style="width: 600px;height: 150px">$!course.process</textarea>
    </td>
   </tr>
   <tr>
