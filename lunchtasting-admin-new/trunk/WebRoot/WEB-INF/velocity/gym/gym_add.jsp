  ...
  <div class="wrap">
    ...
    <table class="list-style">
      <tr>
        ...
        <td>
          <input type="text" class="textBox length-long" id="gym_name" required />
        </td>
      </tr>
      <tr>
        <td style="text-align:right;"><i class="color-red">*</i> 电话：</td>
        <td>
          <input type="text" class="textBox length-long" id="gym_phone" pattern="^([0-9])(,([0-9]))*$" required />
      ...
      <tr>
        ...
        <td>
          <input type="text" class="textBox length-long" id="gym_address" required />
        </td>
      </tr>
      <tr>
        <td style="text-align:right;width:15%;"><i class="color-red">*</i> 缩写地址：</td>
        <td>
          <input type="text" class="textBox" id="gym_simple_address" required />
        </td>
      </tr>
      <tr>
        <td style="text-align:right;"><i class="color-red">*</i> 简介：</td>
        <td>
          <textarea style="width: 500px;height: 100px" id="gym_introduce" required></textarea>
        </td>
      </tr>
      <tr>
